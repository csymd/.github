...
Building rigorous computational systems to model, measure, and understand complex dynamical processes.
...
| Theme | Focus |
|-------|--------|
| **Nonlinear dynamics & complexity** | RQA/CRQA, entropy, and complexity measures that expose temporal structure linear summaries often miss |
| **Physiological & biomechanical signals** | PPG, ECG/HRV, gait, and related modalities — quality-aware features research teams can trust |
...
<sub>cSYMd · Research lab · Open methods where possible</sub>
